...
test('IFrame and ToolTip Tests', async ({ page }) => {
...
test('Autocomplete Tests', async ({ page }) => {
    ...
    const suggesList = frameOne.locator('ul#ui-id-1 li')
    ...
    // expect(await autoInp.inputValue()).toEqual(expText)
